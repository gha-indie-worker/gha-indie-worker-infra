...
output "laptop_ingress" { value = module.cloudflare.laptop_ingress }
output "edge_router_access_verification" { value = module.cloudflare.edge_router_access_verification }
