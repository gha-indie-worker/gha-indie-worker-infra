locals {
  # PR webhook intake is stateless. Durable build/job state remains owned by the
  # existing build-server persistence layer; do not create a fourth Neon project
  # just for CI dispatch.
